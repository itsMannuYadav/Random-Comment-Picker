...
// allows any https host. Everything else stays scoped to our own origin —
// there's no legitimate reason for this app to load scripts, styles, or
// connect out to anywhere else.
